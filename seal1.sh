...
rm  $file_unseal_key_pub $file_unseal_key_priv $file_unseal_key_ctx $file_unseal_key_name -rf
...
echo Seal time: $createelapsedSec sec
...
echo load1 time: $loadelapsedSec sec
